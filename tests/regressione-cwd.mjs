...
out.includes("/home/attacker/lab/sotto/ancora") ? ok("l'utente è dentro ~/lab/sotto/ancora")
...
/\/home\/attacker\/lab/.test(out) ? ok(`la shell è stata riportata a casa: ${out.match(/\/home\/attacker\/lab\S*/)?.[0]}`)
